...
public class QR_Verifification extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public QR_Verifification() {
        initComponents();
        setBounds(445, 163, 516, 419);
        initWebcam();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QR_Verifification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new QR_Verifification().setVisible(true);
        });
    }
    ...
    private void QR_verify_data(String id) {
        try {
            ...
            Logger.getLogger(QR_Verifification.class.getName()).log(Level.SEVERE, null, ex);
        }
