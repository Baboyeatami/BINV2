...
public class Capture_image extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Image Directory");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 500, 50));
    ...
    Boolean NewEntryMode = false;

    public ViewALLDETAILS getViewALLDETAILS() {
        return viewALLDETAILS;
    }

    public void setViewALLDETAILS(ViewALLDETAILS viewALLDETAILS, boolean View) {
        this.viewALLDETAILS = viewALLDETAILS;
        NewEntryMode = View;
    }

    public Legacy_Final getLegacy_Final() {
        return legacy_Final;
    }

    public void setLegacy_Final(Legacy_Final legacy_Final, boolean Entrymode) {
        this.legacy_Final = legacy_Final;
        NewEntryMode = Entrymode;
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            webcam.open();
            BufferedImage file = webcam.getImage();
            if (NewEntryMode) {
                legacy_Final.setImage_captureImage(file);
                legacy_Final.Write_image();
            } else {
                viewALLDETAILS.setImage_captureImage(file);
                viewALLDETAILS.Write_image();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Capture_image.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Capture_image().setVisible(true);
        });
    }
    ...
    public void run() {
        do {
            ...
            if (result != null) {
                ...
                System.out.println(result.getText() + " QR Results ");
    ...
    private void QR_verify_data(String id) {
        try {
            ...
            ResultSet rs;
            ps = c.prepareStatement("SELECT idInformant_info,F_Name,M_Name,L_Name FROM bin.informant_info where idInformant_info='" + id + "';");
            rs = ps.executeQuery();
